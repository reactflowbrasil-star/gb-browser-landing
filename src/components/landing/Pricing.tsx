...
const plans = [
  {
    ...
    desc: "Ideal para experimentar todos os recursos.",
    features: ["Acesso por 7 dias", "Todos os recursos liberados", "Suporte via FAQ"],
    cta: "Começar teste",
    href: "#contato",
    featured: false,
  },
  ...
  },
  {
    ...
    price: "Sob consulta",
    period: "",
    desc: "Para equipes ou uso comercial.",
    features: ["Acesso completo", "Suporte prioritário", "Recursos personalizados", "Multi-aparelhos", "Personalização visual"],
